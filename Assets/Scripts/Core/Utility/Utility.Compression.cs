    ...
    public static partial class Utility
    {
        ...
        public static partial class Compression
        {
            ...
            public static byte[] Compress(byte[] bytes)
            {
                if (bytes == null)
                {
                    throw new MKException("Bytes is invalid.");
                }
            ...
            public static bool Compress(byte[] bytes, int offset, int length, Stream compressedStream)
            {
                ...
                {
                    throw new MKException("Compressed helper is invalid.");
                }
                ...
                {
                    throw new MKException("Offset or length is invalid.");
                }

                if (compressedStream == null)
                {
                    throw new MKException("Compressed stream is invalid.");
                }
                ...
                {
                    if (exception is MKException)
                    {
                        throw;
                    }

                    throw new MKException(Text.Format("Can not compress with exception '{0}'.", exception), exception);
                }
            }
            ...
            public static bool Compress(Stream stream, Stream compressedStream)
            {
                ...
                if (stream == null)
                {
                    throw new MKException("Stream is invalid.");
                }
            ...
            public static bool Decompress(byte[] bytes, int offset, int length, Stream decompressedStream)
            {
                ...
                {
                    throw new MKException("Decompressed stream is invalid.");
                }
                ...
                catch (Exception exception)
                {
                    ...
                    throw new MKException(Text.Format("Can not decompress with exception '{0}'.", exception), exception);
                }
            }
