    ...
    public static partial class Utility
    {
        ...
        public static class Marshal
        {
            ...
            public static void EnsureCachedHGlobalSize(int ensureSize)
            {
                if (ensureSize < 0)
                {
                    throw new MKException("Ensure size is invalid.");
                }
            ...
            internal static byte[] StructureToBytes<T>(T structure, int structureSize)
            {
                if (structureSize < 0)
                {
                    throw new MKException("Structure size is invalid.");
                }
            ...
            internal static void StructureToBytes<T>(T structure, int structureSize, byte[] result, int startIndex)
            {
                ...
                if (result == null)
                {
                    throw new MKException("Result is invalid.");
                }

                if (startIndex < 0)
                {
                    throw new MKException("Start index is invalid.");
                }

                if (startIndex + structureSize > result.Length)
                {
                    throw new MKException("Result length is not enough.");
                }
            ...
            internal static T BytesToStructure<T>(int structureSize, byte[] buffer, int startIndex)
            {
                ...
                if (buffer == null)
                {
                    throw new MKException("Buffer is invalid.");
                }
                ...
                {
                    throw new MKException("Buffer length is not enough.");
                }
