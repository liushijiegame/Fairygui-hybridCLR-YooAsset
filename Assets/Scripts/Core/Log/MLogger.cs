...
namespace MK.Core.Log
{
    ...
    public class MLogger : Singleton<MLogger>
    {
        public static void LogAssert(bool condition, string logStr = "")
        {
            if (!condition)
            {
                ...
                MLogger.Instance.Log(LogLevel.ASSERT, logStr);
            }
        }
        ...
        {
            MLogger.Instance.Log(LogLevel.INFO, logStr);
        }
        ...
        {
            MLogger.Instance.Log(LogLevel.Successd, logStr);
        }
        ...
        {
            MLogger.Instance.Log(LogLevel.WARNING, logStr);
        }
        ...
        {
            MLogger.Instance.Log(LogLevel.ERROR, logStr);
        }
        ...
        {
            MLogger.Instance.Log(LogLevel.EXCEPTION, logStr);
        }

        public static void LogException(string format, params System.Object[] args)
        {
            string msg = string.Format(format, args);
            MLogger.Instance.Log(LogLevel.EXCEPTION, msg);
        }
        ...
        private StringBuilder GetFormatString(LogLevel logLevel, string logString, bool bColor)
        {
            ...
            switch (logLevel)
            {
                case LogLevel.Successd:
                    if (UseCustomColor)
                    {
                        _stringBuilder.AppendFormat("<color=#0099bc><b>[MK] ► </b></color><color=#00FF18><b>[SUCCESSED] ► </b></color>[{0}]  <color=#{2}>{1}</color>",
                            System.DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss fff"), logString, ColorUtils.Green);
                    }
                    else
                    {
                        _stringBuilder.AppendFormat(
                            bColor ? "<color=#0099bc><b>[MK] ► </b></color><color=gray><b>[INFO] ► </b></color>[{0}]  <color=#00FF18>{1}</color>" : "<color=#0099bc><b>[MK] ► </b></color><color=#00FF18><b>[SUCCESSED] ► </b></color>[{0}]  {1}",
                ...
                case LogLevel.INFO:
                    if (UseCustomColor)
                    {
                        _stringBuilder.AppendFormat("<color=#0099bc><b>[MK] ► </b></color><color=gray><b>[INFO] ► </b></color>[{0}]  <color=#{2}>{1}</color>" , 
                            System.DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss fff"), logString,ColorUtils.Black);
                    }
                    else
                    {
                        _stringBuilder.AppendFormat(
                            bColor ? "<color=#0099bc><b>[MK] ► </b></color><color=gray><b>[INFO] ► </b></color>[{0}]  <color=gray>{1}</color>" : "<color=#0099bc><b>[MK] ► </b></color><color=gray><b>[INFO] ► </b></color>[{0}]  {1}",
                            System.DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss fff"), logString);
                    }
                    break;
                case LogLevel.ASSERT:
                    if (UseCustomColor)
                    {
                        _stringBuilder.AppendFormat("<color=#0099bc><b>[MK] ► </b></color><color=#FF00BD><b>[ASSERT] ► </b></color>[{0}]  <color=#{2}>{1}</color>",
                            System.DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss fff"), logString,ColorUtils.Exception);
                    }
                    else
                    {
                        _stringBuilder.AppendFormat(
                            bColor ? "<color=#0099bc><b>[MK] ► </b></color><color=#FF00BD><b>[ASSERT] ► </b></color>[{0}]  <color=green>{1}</color>" : "<color=#0099bc><b>[MK] ► </b></color><color=#FF00BD><b>[ASSERT] ► </b></color>[{0}]  {1}",
                            System.DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss fff"), logString);
                    }
                    break;
                case LogLevel.WARNING:
                    if (UseCustomColor)
                    {
                        _stringBuilder.AppendFormat("<color=#0099bc><b>[MK] ► </b></color><color=#FF9400><b>[WARNING] ► </b></color>[{0}]  <color=#{2}>{1}</color>",
                    ...
                    else
                    {
                        _stringBuilder.AppendFormat(
                            bColor
                                ? "<color=#0099bc><b>[MK] ► </b></color><color=#FF9400><b>[WARNING] ► </b></color>[{0}]  <color=yellow>{1}</color>"
                                : "<color=#0099bc><b>[MK] ► </b></color><color=#FF9400><b>[WARNING] ► </b></color>[{0}]  {1}", System.DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss fff"),
                            logString);
                    }
                    break;
                case LogLevel.ERROR:
                    ...
                    else
                    {
                        _stringBuilder.AppendFormat(
                            bColor 
                                ? "<color=#0099bc><b>[MK] ► </b></color><color=red><b>[ERROR] ► </b></color>[{0}]  <color=red>{1}</color>" 
                                : "<color=#0099bc><b>[MK] ► </b></color><color=red><b>[ERROR] ► </b></color>[{0}]  {1}",
                            System.DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss fff"), logString);
                    }
                    break;
                case LogLevel.EXCEPTION:
                    ...
                    else
                    {
                        _stringBuilder.AppendFormat(
                            bColor
                                ? "<color=#0099bc><b>[MK] ► </b></color><color=red><b>[EXCEPTION] ► </b></color>[{0}]  <color=red>{1}</color>"
                                : "<color=#0099bc><b>[MK] ► </b></color><color=red><b>[EXCEPTION] ► </b></color>[{0}]  {1}",
                            System.DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss fff"), logString);
                    }
                    break;
            }
