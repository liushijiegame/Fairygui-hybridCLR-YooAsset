...
namespace FUIEditor
{
    ...
    {
        // 本工具导出的 CSV 文件路径
        private static readonly string CSVPath = $"{Application.dataPath}/Config/Excel/LocalizeConfig_UI.csv";
        ...
        private static readonly LanguageConfig[] LanguageConfigs = new[]
        {
            ...
            new LanguageConfig { name = "TextJP", comment = "日文" },
            new LanguageConfig { name = "TextFR", comment = "法文" },
            new LanguageConfig { name = "TextGE", comment = "德文" },
            new LanguageConfig { name = "TextSP", comment = "西班牙文" },
            new LanguageConfig { name = "TextPT", comment = "葡萄牙文" },
        };
        ...
        private static void XmlToCSV(string xmlPath, Dictionary<string, I18NItem> oldI18NItemDict)
        {
            ...
            {
                Debug.LogError("FairyGUI 没有导出多语言文件!");
                return;
            }
